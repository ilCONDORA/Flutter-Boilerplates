...
// Filtriamo gli items e manteniamo gli indici originali
    final filteredItemsWithIndices = items.asMap().entries
        .where((entry) => entry.value.isVisible) // Assumendo che ci sia una proprietà isHome
        .toList();
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              if (spacingStyle == SpacingStyle.centered)
