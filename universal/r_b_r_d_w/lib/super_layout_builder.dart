...
import 'package:r_b_r_d_w/widgets/footer.dart';
import 'package:r_b_r_d_w/widgets/logo_navigation.dart';
...
class SuperLayoutBuilder extends StatelessWidget {
  ...
  AppBar? _buildAppBar({
    ...
    } else if (navigationLayout == NavigationLayouts.onlyEndDrawer ||
        navigationLayout == NavigationLayouts.everythingTogether) {
      return AppBar(
  ...
  NavigationDrawer? _buildEndDrawer({
    ...
    if (navigationLayout != NavigationLayouts.onlyBottomAndRail || kIsWeb) {
