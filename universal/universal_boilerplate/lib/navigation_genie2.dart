      ...
      child: Scaffold(
          ...
          bottomNavigationBar: Offstage(
            ...
            child: BottomNavigationBar(
              ...
              items: listOfNavigationProperties.map((individualRoute) {
                return BottomNavigationBarItem(
                  icon: Icon(individualRoute.unselectedIcon),
                  label: individualRoute.label(context),
                );
              }).toList(),
            ...
            color: Colors.black,
            tabs: listOfNavigationProperties.map((individualRoute) {
              return GButton(
                icon: individualRoute.unselectedIcon,
                text: individualRoute.label(context),
              );
            }).toList(),
            selectedIndex: listOfNavigationProperties.indexWhere((element) =>
                element.nameOfRoute ==
                listOfNavigationProperties[navigationShell.currentIndex]
                    .nameOfRoute),
